...
export function ProjectsPage() {
  ...
  const { clients, jobs, products, addProject, updateProject, currentUserRole, hasPermission } = useData();
  const canCreateEditProjects = hasPermission(currentUserRole, 'Create/Edit Projects');
