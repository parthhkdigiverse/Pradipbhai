  ...
  return (
    <div className="h-full flex flex-col relative z-10 animate-in fade-in duration-500 max-w-5xl mx-auto w-full pb-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        {!canChangeSettings && (
          <div className="bg-amber-50 border border-amber-200 text-amber-800 text-xs font-bold px-4 py-2.5 rounded-xl flex items-center gap-2 shadow-sm">
            <AlertCircle className="w-4 h-4 text-amber-600 shrink-0" />
            <span>View Only: Permission to modify settings is disabled for role "{currentUserRole}".</span>
          </div>
        )}
      </div>
