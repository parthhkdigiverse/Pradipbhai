...
export function Header() {
  return (
    <header className="h-16 glass-header flex items-center justify-between px-6 sticky top-0 z-40">
      <div className="flex items-center gap-4">
        ...
        <div className="relative hidden md:block">
          ...
          <input 
            ...
            className="pl-10 pr-4 py-2 glass-input rounded-full text-sm w-64 text-gray-800 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-400/50 transition-all"
          />
          <div className="absolute right-2 top-1/2 -translate-y-1/2 px-1.5 py-0.5 bg-white/40 rounded text-[10px] text-gray-600 font-medium border border-white/50 backdrop-blur-sm">
            ctrl + K
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        <button className="text-gray-600 hover:text-gray-900 transition-colors">
          <div className="w-5 h-3 bg-[url('https://flagcdn.com/w20/us.png')] bg-cover bg-center rounded-sm shadow-sm"></div>
        </button>
        <button className="text-gray-600 hover:text-gray-900 transition-colors">
